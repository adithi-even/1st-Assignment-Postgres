...
const QuestionCreationPage = () => {
    ...
    const clearSearch = () => {
        ...
        setCurrentPage(1);
        fetchQuestions(); // Call fetchQuestions again to reset to normal view
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(`Error ${isEditing ? 'Update' : 'Create'} question:`, error.response ? error.response.data : error.message);
        }
    };

    const handleEdit = (question) => {
        const options = question.options.map(opt => opt.text); //formating
            ...
            <div style={styles.questionList}>
                {questions && Array.isArray(questions) && questions.length > 0 ? (
                    questions.map((q, index) => 
                         ...
                         (
                        <div key={q.id || index} style={styles.question}>
                        ...
                        <p>No questions created yet.{isSearching ? 'Try a different Search Term': 'Create some questions!'}</p>
                    )  
                }
            </div>
             ...
             <div style={styles.modalOverlay}>
                <div style={styles.modal}>
                    <form onSubmit={handleSubmit} style={styles.form}>
                        ...
                        <div>
                            <button onClick={() => setShowModal(false)} type="button" style={styles.cancelButton}>
                                Cancel
                            </button>
